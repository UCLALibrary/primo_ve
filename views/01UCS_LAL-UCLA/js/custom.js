...
/* Collapse "Get It From Other Institutions" dropdown by default in full record display - END */
  ...
  app.component('recordEndNote', {
    ...
    style="border: 2px solid var(--color-primary-blue-04); border-radius: 3px; text-align:left; padding:4px;">
      ...
      <a href="https://www.library.ucla.edu/help/services-resources/handling-books-that-may-contain-heavy-metals/" target="_blank" rel="noopener noreferrer">Handling Books That May Contain Heavy Metals</a>.</b> 
      </span></div>`
  });
